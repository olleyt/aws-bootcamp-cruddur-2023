...
# import Cruddur custom libraries
from lib.cognito_jwt_token import CognitoJwtToken, extract_access_token, TokenVerifyError

# import libraries for HoneyComb 
...
#import libraries for CloudWatch
import watchtower
import logging
...
def data_messages(message_group_uuid):
  ...
  try:
    ...
    # unauthenicatied request
    print('TOKEN PROBLEM', flush=true)
    app.logger.debug(e)
    return {}, 401
...
def data_create_message():
  ...
  try:
    ...
    print('TOKEN PROBLEM in POST/OPTIONS', flush=True)
    # unauthenicatied request
    app.logger.debug(e)
    return {}, 401
